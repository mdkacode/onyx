...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@naarni.app")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="naarni.app")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    cta_link = "https://www.naarni.app/pricing"
    ...
    text_content = (
        ...
        "If you change your mind, visit https://www.naarni.app/pricing"
    )
    send_email(
        user_email,
        subject,
