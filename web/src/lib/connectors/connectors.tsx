...
• Specifying sites currently works for SharePoint instances using English, Spanish, or German. Contact the Naarni team if you need another language supported.
`,
      },
    ],
    advanced_values: [
